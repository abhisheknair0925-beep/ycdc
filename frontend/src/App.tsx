              ...
              <div className="container hero-container">
                <div ref={heroTextRef} className="reveal reveal-left hero-content-wrapper" style={{ transition: 'none' }}>
                  ...
                  <div className="hero-slide-container">
                    {HERO_SLIDES.map((slide, idx) => {
                      ...
                      return (
                        ...
                        >
                          <span className="badge badge-premium animate-float" style={{ marginBottom: '20px', backgroundColor: 'rgba(87, 85, 39, 0.55)', color: '#ECC4C3', borderColor: 'rgba(197, 211, 193, 0.7)' }}>
                            {slide.badge}
                          </span>
                  ...
                  <div className="hero-ctas">
                    <button onClick={() => dispatch(openBookingModal(undefined))} className="btn btn-primary spring-button" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div className="treatment-layout">
                  ...
                  <div className="reveal reveal-left" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div style={{ textAlign: 'left', marginTop: '10px' }}>
                      <button onClick={() => dispatch(openBookingModal(undefined))} className="btn btn-primary" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div className="floating-cta-phone">
            <div style={{ position: 'relative' }}>
              <div style={{
                ...
                bottom: '-5px',
                borderRadius: '50%',
                border: '2px solid var(--soldier-green)',
              ...
              <button
                ...
                style={{
                  ...
                  height: '56px',
                  borderRadius: '50%',
                  backgroundColor: 'var(--soldier-green)',
                  color: '#FAF7F2',
                  border: '2px solid #FAF7F2',
                  cursor: 'pointer',
                  boxShadow: '0 6px 20px rgba(87, 85, 39, 0.5)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  position: 'relative',
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 8px 24px rgba(87, 85, 39, 0.7)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0) scale(1)';
                  e.currentTarget.style.boxShadow = '0 6px 20px rgba(87, 85, 39, 0.5)';
                }}
                title="Call Us Now"
              >
                <Phone size={24} />
