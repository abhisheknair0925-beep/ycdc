          ...
          <div style={{
            ...
            <button
              ...
              style={{
                padding: '10px 22px',
                borderRadius: '50px',
                border: filter === 'all' ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                backgroundColor: filter === 'all' ? 'var(--soldier-green)' : 'white',
                color: filter === 'all' ? '#FAF7F2' : 'var(--soldier-green)',
                fontWeight: '600',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
                boxShadow: filter === 'all' ? '0 4px 15px rgba(87, 85, 39, 0.35)' : 'none',
            ...
            <button
              ...
              style={{
                padding: '10px 22px',
                borderRadius: '50px',
                border: filter === 'infrastructure' ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                backgroundColor: filter === 'infrastructure' ? 'var(--soldier-green)' : 'white',
                color: filter === 'infrastructure' ? '#FAF7F2' : 'var(--soldier-green)',
                fontWeight: '600',
                cursor: 'pointer',
                boxShadow: filter === 'infrastructure' ? '0 4px 15px rgba(87, 85, 39, 0.35)' : 'none',
                transition: 'var(--transition-fast)'
              }}
            >
            ...
            <button
              ...
              style={{
                padding: '10px 22px',
                borderRadius: '50px',
                border: filter === 'treatments' ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                backgroundColor: filter === 'treatments' ? 'var(--soldier-green)' : 'white',
                color: filter === 'treatments' ? '#FAF7F2' : 'var(--soldier-green)',
                fontWeight: '600',
                cursor: 'pointer',
                boxShadow: filter === 'treatments' ? '0 4px 15px rgba(87, 85, 39, 0.35)' : 'none',
                transition: 'var(--transition-fast)'
              }}
            >
              Treatments & Clinical
            ...
            <button
              ...
              style={{
                padding: '10px 22px',
                borderRadius: '50px',
                border: filter === 'video' ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                backgroundColor: filter === 'video' ? 'var(--soldier-green)' : 'white',
                color: filter === 'video' ? '#FAF7F2' : 'var(--soldier-green)',
                fontWeight: '600',
                cursor: 'pointer',
                display: 'flex',
                alignItems: 'center',
                gap: '6px',
                boxShadow: filter === 'video' ? '0 4px 15px rgba(87, 85, 39, 0.35)' : 'none',
                transition: 'var(--transition-fast)'
              }}
            >
