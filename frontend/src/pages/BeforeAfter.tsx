            ...
            {caseStudies.map((c: any) => (
              <button
                ...
                style={{
                  padding: '12px 26px',
                  borderRadius: '50px',
                  border: activeCategory === c.category ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                  backgroundColor: activeCategory === c.category ? 'var(--soldier-green)' : 'white',
                  color: activeCategory === c.category ? '#FAF7F2' : 'var(--soldier-green)',
                  fontWeight: '600',
                  cursor: 'pointer',
                  boxShadow: activeCategory === c.category ? '0 4px 15px rgba(87, 85, 39, 0.4)' : 'var(--shadow-sm)',
