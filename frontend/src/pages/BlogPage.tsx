            ...
            <div className="glass animate-scale-up" style={{
              ...
              <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', marginBottom: '20px', fontSize: '0.85rem', color: 'var(--muted-charcoal)', borderBottom: '1px solid var(--silk-200)', paddingBottom: '16px' }}>
                <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <User size={14} style={{ color: 'var(--soldier-green)' }} /> {selectedPost.author}
                </span>
                <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <Calendar size={14} style={{ color: 'var(--soldier-green)' }} /> {selectedPost.date}
                </span>
                <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <Clock size={14} style={{ color: 'var(--soldier-green)' }} /> {selectedPost.read_time}
                </span>
              ...
              {/* Article Title */}
              <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '2.5rem', color: 'var(--dark-green-900)', marginBottom: '24px', lineHeight: '1.2' }}>
                {selectedPost.title}
              </h2>
              ...
              <div style={{
                ...
                <h4 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.4rem', color: 'var(--dark-green-900)', marginBottom: '8px' }}>
                  ...
                  {(['all', 'skin', 'hair', 'anti-aging'] as const).map((cat) => (
                    <button
                      ...
                      style={{
                        padding: '10px 22px',
                        borderRadius: '50px',
                        border: activeCategory === cat ? '2px solid var(--soldier-green)' : '1px solid var(--silk-200)',
                        backgroundColor: activeCategory === cat ? 'var(--soldier-green)' : 'white',
                        color: activeCategory === cat ? '#FAF7F2' : 'var(--soldier-green)',
                        fontWeight: '600',
                        cursor: 'pointer',
                        boxShadow: activeCategory === cat ? '0 4px 15px rgba(87, 85, 39, 0.35)' : 'none',
